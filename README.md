...
2. **Тестирование GUI:** Проверка корректности работы ПДА, инвентаря, шкалы здоровья и индикаторов заражений
3. **Тестирование производительности:** Проверка стабильности частоты кадров при подгрузке высоконагруженных безопасных зон 
4. Выявление багов и их документирование.

### 2.2 Область применения
* Модуль взаимодействия с открытым миром 
...
* **Железо:** AMD Ryzen 5 5600X, 16GB RAM, NVIDIA RTX 5060Ti.
...
* **Test Suite 3: Производительность**
    * TC-06 Загрузка и рендеринг локации с большим онлайном.
